namespace WebApi.Features.PrototypeSets.Requests
{
    ...
    public class CreatePrototypeSetCommand : IRequest<PrototypeSetDto>
    {
        [Required]
        ...
        public class Handler : IRequestHandler<CreatePrototypeSetCommand, PrototypeSetDto>
        {
            ...
            public async Task<PrototypeSetDto> Handle(
                CreatePrototypeSetCommand request,
                CancellationToken cancellationToken)
            {
                ...
                dbContext.PrototypeSets.Add(prototypeSet);
        ...
        public class Validator : AbstractValidator<CreatePrototypeSetCommand>
        {
            public Validator()
            {
